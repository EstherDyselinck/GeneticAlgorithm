class DNA {
  ...
  //----------------------------------------------------------------------------------------------------------------------PROPERTIES
  private Geno genoType;              // The object GENOTYPE
  private boolean[][][] genes;        // The array that stores the PHENOTYPE
  ...
  DNA() {
    ...
    int[][] genoArray = genoType.getGenoArrayG();
    for (int i=0; i<numberOfTowers; i++) {
      int x=genoArray[i][0];
      int y=genoArray[i][1];
      for (int j=0; j<genoArray[i][3]; j++) {
        int z=genoArray[i][2]+j;
        genes[x][y][z]=true;
      }
    }
  ...
  int[][] getGenoArrayF() {
    int[][] genoArray;
    genoArray = genoType.getGenoArrayG();
    return genoArray;
  }
  
  //----------------------------------------------------------------------------------------------------------------------SET the GENO ARRAY
  void setGenoArrayF(int[][] genoArrayF) {
    genoType.setGenoArrayG(genoArrayF);
  }
